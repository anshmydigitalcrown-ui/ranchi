      ...
      <main>
          ...
          <div className="relative max-w-6xl mx-auto z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a 
                ...
                className="bg-white text-pink-600 px-8 py-4 rounded-full font-bold hover:bg-pink-50 transition-colors shadow-lg flex items-center gap-3"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                ...
                className="bg-green-500 text-white px-8 py-4 rounded-full font-bold hover:bg-green-600 transition-colors shadow-lg flex items-center gap-3"
              >
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
                Find Premium Ranchi Escorts - Our Locations
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Contact us for premium escort services across Ranchi and surrounding areas.
              </p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-8 rounded-2xl shadow-xl">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <strong>Address:</strong> Main Road, Central Ranchi, Jharkhand 834001
                    </div>
                  </div>
                  <div className="flex items-start">
                    <svg className="w-5 h-5 text-pink-600 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <strong>Phone:</strong> <a href="tel:+919372662471" className="text-pink-600 hover:underline">+91-9372662471</a>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <svg className="w-5 h-5 text-pink-600 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-2xl shadow-xl">
                <h3 className="text-2xl font-bold text-green-600 mb-6 flex items-center">
                  ...
                  Service Coverage - Ranchi Metropolitan
                </h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <strong>Coverage:</strong> Complete Ranchi Metropolitan Region
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      <strong>WhatsApp:</strong> <a href="https://wa.me/919372662471" className="text-green-600 hover:underline">+91-9372662471</a>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <svg className="w-5 h-5 text-green-600 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <strong>Email:</strong> <a href="mailto:sanjanadotsingh@gmail.com" className="text-green-600 hover:underline">sanjanadotsingh@gmail.com</a>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <svg className="w-5 h-5 text-green-600 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <strong>Service:</strong> Outcall & Incall Available
                    </div>
                  </div>
                </div>
              </div>
