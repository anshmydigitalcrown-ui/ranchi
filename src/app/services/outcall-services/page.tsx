...
export const metadata: Metadata = {
  title: 'Outcall Services in Ranchi 💎 Professional Outcall Escorts | Call +91-9372662471',
  ...
  openGraph: {
    title: 'Outcall Services in Ranchi 💎 Professional Outcall Escorts',
        ...
        <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-600 via-rose-600 to-red-600 text-white overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 max-w-4xl mx-auto">
              <p className="text-pink-100 text-lg">✓ Hotel Visits • ✓ Home Visits • ✓ Discreet Arrival • ✓ Professional Service • ✓ 24/7 Available</p>
            </div>
          </div>
        </section>
